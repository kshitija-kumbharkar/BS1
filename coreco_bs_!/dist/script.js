document.addEventListener('DOMContentLoaded', function () {
    // Sample user data
    const users = [
        { username: 'Kshitija', password: 'adminpass', role: 'Admin' },
        { username: 'Keshav', password: 'company1pass', role: 'Employee' },
        { username: 'Madhav', password: 'company2pass', role: 'Employee' },
        { username: 'Priya', password: 'company3pass', role: 'Employee' },
        { username: 'Radhika', password: 'company4pass', role: 'Employee' },
        { username: 'Ram', password: 'company5pass', role: 'Employee' }
    ];
